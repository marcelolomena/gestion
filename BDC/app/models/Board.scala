...
case class Task(projectId : Long,
                  name : String,
...
object Task {
  ...
  //simple
  implicit val simple: RowParser[Task] = {
    get[Long]("project_id") ~
      get[String]("name") ~
  ...
  //TODO: Task Row Parser
  implicit val fakeParser: RowParser[(Task,Option[UserBase],Option[CommentItem])] = {
      simple ~
      UserBase.userParser.? ~
