...
module.exports = function (passport) {
    ...
    router.route('/factura/prefactura/:id/:sap')
    ...
    router.route('/prefacturas/proveedores')
        .get(isAuthenticated, prefacturasController.getProveedores);

    router.route('/prefacturas/excel')
        .get(isAuthenticated, prefacturasController.getExcel);             
