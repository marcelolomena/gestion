...
//   models.equipos.findAll({ /*where: { 'borrado': 1 },*/ order: 'id' }).then(function (equipos) {
//       res.json(equipos);
//   }).catch(function (err) {
//       logger.error(err);
        ...
        if (err) {
            ...
            models.equipos.count({
                ...
                models.equipos.findAll({
                    ...
                    res.json({ records: records, total: total, page: page, rows: equipos });
                }).catch(function (err) {
                    logger.error(err);
                    res.json({ error_code: 1 });
                });
...
exports.getExcel = function (req, res) {
  ...
  var sql = "SELECT id,nombre,fecha_nacimiento,rut FROM art_live.dbo.equipos; "
