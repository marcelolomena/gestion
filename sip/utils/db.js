...
/**
 * abrirConexion
 * @author Marcelo Lome�a
 * @version 0.0.1
 * @since 01/04/2016
 * @syntax abrirConexion();
 * Este metodo establece la conexi�n a la base de datos.
 * @param {function} callback
 * @returns {request} M�todo y funciones para interactuar con sql server.
 */
 ...
 * Este m�todo desconecta la base de datos.
 * @return {undefined}
 */
 ...
 * Este m�todo devuelve los resultados de una consulta en un array.
 * @author Marcelo Lome�a
 * @version 0.0.1
 * @since 01/04/2016
...
/**
 * devolverConsultaSp
 * M�todo que se encarga de la ejecuci�n de cualquier tipo de procedimiento
 * almacenado solo indicando nombre del mismo y par�metros. Devuelve un json
 * con todos los registros de la ejecuci�n.
 * @author Marcelo Lome�a
 * @version 0.0.1
 * @since 2014-10-13
...
return {
    ...
    AdministrarData: (function () {
        /**
         * CargarMaestro
         * M�todo p�blico que en base al origen de datos que se le pase como
         * par�metro trae la informaci�n de las tablas, vistas o procedimientos
         * almacenado seg�n el tipo de orig�n solicitado.
         * @author Marcelo Lome�a
         * @version 0.0.1
         * @since 2014-08-10
        ...
        /**
         * CargarMaestroCampo
         * Este m�todo p�blico se encarga de cargar los campos y su tipo de
        ...
        /**
         * CargarSpDatos
         * M�todo p�blico que se encarga de ejecutar cualquier procedimiento
         ...
         * @param {array} arrParam json con el nombre y valor de los par�metros del procedimiento almacenado.
         * @param {function} callback
         * @returns {undefined}
         */
