        ...
        },
        {
            ...
            beforeSubmit: function (postdata, formid) {
                ...
                if (rowKey == null) {
                    var resp;
                    $.ajax({
                        url: "/presupuestogetrol/",
                        dataType: 'json',
                        async: false,
                        success: function (j) {
                            console.log("***Respuesta:" + j.error_code);
                            if (j.error_code == 10) {
                                //alert("Debe seleccionar un presupuesto base");
                                //return [false, "Debe seleccionar un presupuesto base", ""];
                                resp = j.error_code;
                            }
                        }
                    });                    
                    ...
                    if (resp == 10){
                        return [false, "Debe seleccionar un presupuesto base. Presione Cancelar, seleccione un presupuesto base y luego boton +", ""];
                    }                    
                    //alert("Esta opción agrega presupuesto para un nuevo CUI.\nPara una nueva versión de presupuesto:\n   1.-Seleccione versión base\n   2.-Presione boton agregar");
                    //return [false, "", ""];
                } else {
                ...
                if (rowKey == null) {
                    ...
                    $.ajax({
                        ...
                        success: function (j) {
                            console.log("***Respuesta:" + j.error_code);
                            if (j.error_code == 10) {
                                alert("NO ha seleccionado un presupuesto base. Debe hacer click en alguno de sus presupuestos y luego el boton + .");
                            }
                        }
                    });                           
                } else {
