...
var gridEvaluacionEco = {
    ...
    renderGrid: function (loadurl, parentRowKey, targ) {
        ...
        tmplServ += "<div class='form-row'>";
        tmplServ += "<div class='column-full'>Clase de Evaluación Técnica<span style='color:red'>*</span>{claseevaluaciontecnica}</div>";
        tmplServ += "</div>";
        ...
        $gridTab.jqGrid({
            ...
            pager: '#navGridEvEco',
            subGrid: true,
            subGridRowExpanded: showSubGridsCot,
            subGridOptions: {
...
function showSubGridsCot(subgrid_id, row_id) {
    gridCotizaciones(subgrid_id, row_id, 'cotizacion');
