$(document).ready(function () {
    ...
    function showChildGrid(parentRowID, parentRowKey) {
        ...
        tabs += "<div class='tab-pane' id='contratoadjudicado'><table id='contratoadjudicado_t_" + parentRowKey + "'></table><div id='navGridSolCon'></div></div>"
        tabs += "<div class='tab-pane' id='clausulas'><table id='clausulas_t_" + parentRowKey + "'></table><div id='navGridClau'></div></div>"
