...
var gridParticipantesPro = {
    ...
    renderGrid: function (loadurl, parentRowKey, targ) {
        ...
        $gridTab.jqGrid({
            ...
            subGrid: true,
            subGridRowExpanded: showSubGridsServ2,
            subGridOptions: {
        ...
        $gridTab.jqGrid('navGrid', '#navGridPartPro', { edit: false, add: false, del: false, search: false },
            {
...
function showSubGridsServ2(subgrid_id, row_id) {
    gridProveedores2(subgrid_id, row_id, 'proveedores');
}

function gridProveedores2(parentRowID, parentRowKey, suffix) {
...
*/
    ...
    $("#" + childGridID).jqGrid({
        ...
        subGrid: true,
        subGridRowExpanded: showSubGridsProPart,
        subGridOptions: {
            plusicon: "glyphicon-hand-right",
            minusicon: "glyphicon-hand-down"
        },
...
function showSubGridsProPart(subgrid_id, row_id) {
    gridParticipantesFinal(subgrid_id, row_id, 'participantesfinal');
}

function gridParticipantesFinal(parentRowID, parentRowKey, suffix) {
    var subgrid_id = parentRowID;
    var row_id = parentRowKey;
    var subgrid_table_id, pager_id, toppager_id;
    subgrid_table_id = subgrid_id + '_t';
    ...
    tmplServ += "<div class='form-row'>";
    tmplServ += "<div class='column-full'>Nombre<span style='color:red'>*</span>{nombre}</div>";
    tmplServ += "</div>";
    tmplServ += "<div class='form-row'>";
    tmplServ += "<div class='column-full'>Cargo<span style='color:red'>*</span>{cargo}</div>";
    tmplServ += "</div>";
...
*/
    ...
    var childGridURL = "/sic/responsables/" + parentSolicitud;

    var modelIniciativaFecha = [
        { name: 'id', index: 'id', key: true, hidden: true },
        { label: 'Nombre', name: 'nombre', width: 600, search: false, editable: true, hidden: false },
        { label: 'Cargo', name: 'cargo', width: 600, search: false, editable: true, hidden: false },
