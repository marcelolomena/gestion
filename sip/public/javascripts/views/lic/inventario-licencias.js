$(document).ready(function () {
    ...
    t1 += "<div class='column-half' id='d_idfabricante'>CUI Responsable Proyecto<span style='color:red'>*</span>{idfabricante}</div>";
    t1 += "<div class='column-half' id='d_software'>Software<span style='color:red'>*</span>{software}</div>";
    t1 += "</div>";

    t1 += "<div class='form-row'>";
    t1 += "<div class='column-half' id='d_idtipoinstalacion'>¿Donde está instalada?<span style='color:red'>*</span>{idtipoinstalacion}</div>";
    t1 += "<div class='column-half' id='d_idclasificacion'>Clasificación{idclasificacion}</div>";
    t1 += "</div>";

    t1 += "<div class='form-row'>";
    t1 += "<div class='column-half' id='d_idtipolicenciamiento'>Tipo de Licenciamiento<span style='color:red'>*</span>{idtipolicenciamiento}</div>";
    t1 += "<div class='column-half' id='d_utilidad'>Utilidad{utilidad}</div>";
    t1 += "</div>";

    t1 += "<div class='form-row'>";
    t1 += "<div class='column-half' id='d_comentarios'>Comentarios{comentarios}</div>";
    t1 += "</div>";
    ...
    var $grid = $("#gridMaster"), licenciaModel = [
        { label: 'ID', name: 'id', key: true, hidden: true },
        { label: 'Fabricante', name: 'idfabricante', width: 60, hidden: false, search: false, editable: true, formatter: 'integer',editrules: { required: true } },
        {
