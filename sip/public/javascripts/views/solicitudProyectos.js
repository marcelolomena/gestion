$(document).ready(function () {
    ...
    var modelSolicitudAprobacion = [
        ...
        { label: 'Responsable', name: 'nombreresponsable', width: 150, align: 'left', search: true, editable: false },
        { label: 'Contrato', name: 'contrato', width: 250, align: 'left', search: true, editable: false },
        { label: 'SAP', name: 'sap', width: 50, align: 'left', search: true, editable: false },
        { label: 'Tarea', name: 'tarea', width: 70, align: 'left', search: true, editable: false },
            ...
            bootbox.confirm("¿Esta seguro de confirmar la generación de solicitudes?", function (confirmed) {
                if (confirmed == true) {
                    ...
                    dialog.init(function () {
                        $.ajax({
                            url: '/solicitud/generarProyectos'
                        }).done(function (data) {
