...
function gridIniciativaFechaPrep(parentRowID, parentRowKey, suffix ) {
    var subgrid_id = parentRowID;
    var row_id = parentRowKey;
    var subgrid_table_id, pager_id, toppager_id;
    subgrid_table_id = subgrid_id + '_t';
    ...
    var childGridID = subgrid_table_id;
    var childGridPagerID = pager_id;
    var childGridURL = "/iniciativafechafp/" + parentRowKey;
    ...
    var modelIniciativaFecha = [
...

        {
            ...
            editrules: {required: true},
            editoptions: {
                dataUrl: '/iniciativagetfechasiniprep',
                buildSelect: function (response) {
                    var grid = $("#" + childGridID);
                    var rowKey = grid.getGridParam("selrow");
                    var rowData = grid.getRowData(rowKey);
    ...
    $("#" + childGridID).jqGrid({
        ...
        height: 'auto',
        pager: "#" + childGridPagerID,
        editurl: '/iniciativafecha/actionfp',
        gridComplete: function () {
            var recs = $("#" + childGridID).getGridParam("reccount");
            if (isNaN(recs) || recs == 0) {
